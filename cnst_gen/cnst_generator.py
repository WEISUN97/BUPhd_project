...
class CNSTGenerator:
    def __init__(self, gdsReso: float = 0.001, shapeReso: float = 0.01) -> None:
        ...
        self.jar_path = os.path.join(CNST_PATH, "CNSTNanolithographyToolboxV2016.10.01.jar")
    ...
    def generate(self, filename: str, save_path:str, show=False) -> None:
        ...
        if self._is_mac_os():
            ...
            result = subprocess.run(java_command, shell=True, capture_output=True, text=True, encoding='ISO-8859-1')
        end_time = time.time()
